...
int oak_entity_get_id_from_native(librg_entity *);
...
ZPL_JOIN2(mafia_,NAME) *ZPL_JOIN3(oak_entity_,NAME,_get_from_native)(librg_entity *entity) { \
    ZPL_ASSERT_NOT_NULL(entity); \
    return (ZPL_JOIN2(mafia_,NAME) *)oak_entity_get(ID, oak_entity_get_id_from_native(entity)); \
}

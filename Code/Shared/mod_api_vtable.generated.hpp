...
oak_add_ban_ptr *add_ban;
oak_remove_ban_ptr *remove_ban;
oak_add_wh_ptr *add_wh;
oak_remove_wh_ptr *remove_wh;
oak_toggle_wh_ptr *toggle_wh;
oak_player_kick_ptr *player_kick;
